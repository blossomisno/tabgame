            ...
            function(require, module, exports) {
                ...
                Pay.prototype = {
                    submit: function(currency, to, value, payload, options) {
                        ...
                        value = value || '0'
                        var amount = new BigNumber(value).times(
                            '1000000000000000000'
                        ) //10^18
                        var params = {
                ...
                function openApp(params, options) {
                    ...
                    var url =
                        'openapp.NASnano://virtual?params=' +
     ...
     */
         ...
         */
                        BigNumber.config = BigNumber.set = function() {
                            ...
                            if (
                                has((p = 'DECIMAL_PLACES')) &&
                                isValidInt(v, 0, MAX, 2, p)
                            ) {
                                DECIMAL_PLACES = v | 0
                            }
                            r[p] = DECIMAL_PLACES
                        ...
                        div = (function() {
                            ...
                            return function(x, y, dp, rm, base) {
                                ...
                                if (!base) {
                                    base = BASE
                                    e =
                                        bitFloor(x.e / LOG_BASE) -
                                        bitFloor(y.e / LOG_BASE)
                                    s = (s / LOG_BASE) | 0
                                }
         ...
         */
                        function format(n, i, rm, caller) {
                            ...
                            rm =
                                rm != null &&
                                isValidInt(rm, 0, 8, caller, roundingMode)
                                    ? rm | 0
                                    : ROUNDING_MODE
         ...
         */
                        function intValidatorWithErrors(
                            n,
                            min,
                            max,
                            caller,
                            ...
                            return function(x, str, num, b) {
                                ...
                                if (isInfinityOrNaN.test(s)) {
                                    ...
                                    if (!num) {
                                        ...
                                        s = s.replace(basePrefix, function(
                                            m,
                                            p1,
                                            p2
                                        ) {
         ...
         */
                        P.greaterThanOrEqualTo = P.gte = function(y, b) {
                            id = 7
                            return (
                                (b = compare(this, new BigNumber(y, b))) ===
                                    1 || b === 0
                            )
                        }
         ...
         */
                        P.isInteger = P.isInt = function() {
                            return (
                                !!this.c &&
                                bitFloor(this.e / LOG_BASE) > this.c.length - 2
                            )
                        }
         ...
         */
                        P.minus = P.sub = function(y, b) {
                            ...
                            if ((a = xe - ye)) {
                                ...
                                j = (xLTy = (a = xc.length) < (b = yc.length))
                                    ? a
                                    : b
                        ...
                        P.round = function(dp, rm) {
                            ...
                            if (dp == null || isValidInt(dp, 0, MAX, 15)) {
                                round(
                                    ...
                                    ~~dp + this.e + 1,
                                    rm == null ||
                                    !isValidInt(rm, 0, 8, 15, roundingMode)
                                        ? ROUNDING_MODE
                                        : rm | 0
                                )
                            }
         ...
         */
                        P.toDigits = function(sd, rm) {
                            ...
                            sd =
                                sd == null ||
                                !isValidInt(sd, 1, MAX, 18, 'precision')
                                    ? null
                                    : sd | 0
                            rm =
                                rm == null ||
                                !isValidInt(rm, 0, 8, 18, roundingMode)
                                    ? ROUNDING_MODE
                                    : rm | 0
         ...
         */
                        P.toExponential = function(dp, rm) {
                            return format(
                                this,
                                dp != null && isValidInt(dp, 0, MAX, 19)
                                    ? ~~dp + 1
                                    : null,
                                rm,
                                19
                            ...
                            if (this.c) {
                                ...
                                if (g1 > 0 && len > 0) {
                                    ...
                                    for (; i < len; i += g1) {
                                        intPart +=
                                            groupSeparator +
                                            intDigits.substr(i, g1)
                                    }

                                    if (g2 > 0)
                                        intPart +=
                                            groupSeparator + intDigits.slice(i)
         ...
         */
                        P.toPower = P.pow = function(n, m) {
                            ...
                            return z
                                ? y.mod(z)
                                : k
                                    ? round(y, POW_PRECISION, ROUNDING_MODE)
                                    : y
                        }
         ...
         */
                        P.toPrecision = function(sd, rm) {
                            return format(
                                this,
                                sd != null &&
                                isValidInt(sd, 1, MAX, 24, 'precision')
                                    ? sd | 0
                                    : null,
                                rm,
                                24
     ...
     */
        ...
        12: [
            function(require, module, exports) {
                ...
                exports.toCanvas = renderCanvas.bind(
                    null,
        ...
        14: [
            function(require, module, exports) {
                ...
                AlphanumericData.getBitsLength = function getBitsLength(
                    length
                ) {
            ...
            function(require, module, exports) {
                ...
                BitBuffer.prototype = {
                    get: function(index) {
                        ...
                        return (
                            ((this.buffer[bufIndex] >>> (7 - (index % 8))) &
                                1) ===
                            1
                        )
                    },
            ...
            function(require, module, exports) {
                    ...
                    for (var row = 0; row < size; row++) {
                        ...
                        for (var col = 0; col < size; col++) {
                            ...
                            if (module === lastCol) {
                                ...
                                if (sameCountCol >= 5)
                                    points +=
                                        PenaltyScores.N1 + (sameCountCol - 5)
                                lastCol = module
                                sameCountCol = 1
                            }
                            ...
                            if (module === lastRow) {
                                ...
                                if (sameCountRow >= 5)
                                    points +=
                                        PenaltyScores.N1 + (sameCountRow - 5)
                                lastRow = module
                                sameCountRow = 1
                            }
                        }
                ...
                exports.getPenaltyN3 = function getPenaltyN3(data) {
                    ...
                    for (var row = 0; row < size; row++) {
                        ...
                        for (var col = 0; col < size; col++) {
                            bitsCol =
                                ((bitsCol << 1) & 0x7ff) | data.get(row, col)
                            if (
                                col >= 10 &&
                                (bitsCol === 0x5d0 || bitsCol === 0x05d)
                            )
                                points++

                            bitsRow =
                                ((bitsRow << 1) & 0x7ff) | data.get(col, row)
                            if (
                                col >= 10 &&
                                (bitsRow === 0x5d0 || bitsRow === 0x05d)
                            )
                                points++
                        }
                    }
                 ...
                 */
                exports.getBestMask = function getBestMask(
                    data,
                    setupFormatFunc
                ) {
        ...
        25: [
            function(require, module, exports) {
                 ...
                 */
                exports.getBestModeForData = function getBestModeForData(
                    dataStr
                ) {
        ...
        31: [
            function(require, module, exports) {
                ...
                exports.fromString = function fromString(data, version) {
                    var segs = getSegmentsFromString(
                        data,
        ...
        33: [
            function(require, module, exports) {
                ...
                function getTotalBitsFromDataArray(segments, version) {
                    ...
                    segments.forEach(function(data) {
                        var reservedBits = getReservedBitsCount(
                            data.mode,
                            version
                        )
                ...
                function getBestVersionForMixedData(
                    ...
                    for (
                        ...
                        var length = getTotalBitsFromDataArray(
                            segments,
                            currentVersion
                        )
                        if (
                ...
                exports.getCapacity = function getCapacity(
                    ...
                    var usableBits =
                        dataTotalCodewordsBits -
                        getReservedBitsCount(mode, version)
        ...
        36: [
            function(require, module, exports) {
                ...
                exports.getOptions = function getOptions(options) {
                    ...
                    var width =
                        options.width && options.width >= 21
                            ? options.width
                            : undefined
                ...
                exports.qrToImageData = function qrToImageData(
                    imgData,
                    qr,
                    opts
                ) {
                    ...
                    var symbolSize = Math.floor(
                        (size + opts.margin * 2) * scale
                    )
                    ...
                    for (var i = 0; i < symbolSize; i++) {
                        for (var j = 0; j < symbolSize; j++) {
                            ...
                            if (
                                ...
                                var iSrc = Math.floor(
                                    (i - scaledMargin) / scale
                                )
                                var jSrc = Math.floor(
                                    (j - scaledMargin) / scale
                                )
                                pxColor =
                                    palette[data[iSrc * size + jSrc] ? 1 : 0]
                            }
